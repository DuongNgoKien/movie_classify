...
parser.add_argument('--rgb-list', default='../features/list/rgb.list', help='list of rgb features ')
parser.add_argument('--flow-list', default='../features/list/flow.list', help='list of flow features')
parser.add_argument('--audio-list', default='../features/list/audio.list', help='list of audio features')
parser.add_argument('--test-rgb-list', default='../features/list/rgb.list', help='list of test rgb features ')
parser.add_argument('--test-flow-list', default='../features/list/flow.list', help='list of test flow features')
parser.add_argument('--test-audio-list', default='../features/list/audio.list', help='list of test audio features')
